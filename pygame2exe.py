...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "Sound_Surfer.py"
 
        #Name of program
        self.project_name = "Sound Surfer"
 
        #Project url
        self.project_url = "matt:maxime"
 
        #Version of program
        self.project_version = "19.0"
 
        #License of the program
        self.license = "B&H Foundation"
 
        #Auhor of program
        self.author_name = "Maxime H. & Matt B."
        self.author_email = "mbichay@csumb.edu, mhemion@csumb.edu"
        self.copyright = "Copyright (c) 2009 S.Skills"
 
        #Description
        self.project_description = "Challenging game of sound, concentration, and determination."
